import { Box, Divider, Group, Radio, RadioGroup, Text, TextInput, Title } from '@mantine/core';
...
const QuestionAddPart5 = (props: QuestionAddPart1Prop) => {
...
export default QuestionAddPart5;
