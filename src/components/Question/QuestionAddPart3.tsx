import { Box, Button, Group, Radio, RadioGroup, Text, TextInput, Title } from '@mantine/core';
...
const QuestionAddPart3 = (props: QuestionAddPart3Prop) => {
...
export default QuestionAddPart3;
